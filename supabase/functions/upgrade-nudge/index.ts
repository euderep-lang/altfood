  ...
  <div style="max-width:560px;margin:0 auto;padding:40px 20px;">
    <div style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
      ...
      <div style="padding:32px 28px;">
        ...
        <h3 style="color:#1a1a1a;font-size:15px;margin:0 0 12px;">Com o plano Pro (R$ 19,90/mês, renovação mensal) você para de responder substituição no WhatsApp. Acesso após o pagamento; nos primeiros 14 dias, cancelamento com reembolso integral do valor pago.</h3>
