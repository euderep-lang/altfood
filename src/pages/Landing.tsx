  ...
  return (
    <div className="relative mx-auto w-[min(100%,278px)]">
      ...
      <div className="relative bg-gradient-to-b from-zinc-800 to-zinc-950 rounded-[2.85rem] p-[10px] shadow-[0_28px_70px_-14px_rgba(0,0,0,0.55)] ring-1 ring-white/10">
        <div className="absolute top-[11px] left-1/2 -translate-x-1/2 w-[72px] h-[26px] bg-black rounded-full z-20 shadow-inner" />
        <div className="rounded-[2.25rem] overflow-hidden bg-background shadow-inner">
          {/* Cabeçalho no estilo PatientPage (página real do paciente) */}
            ...
            <div className="px-3 pb-3 pt-9">
              <div className="flex items-start gap-2.5">
                ...
                <div className="min-w-0 flex-1 pt-0.5">
                  ...
                  <p className="mt-0.5 text-[10px] leading-snug text-muted-foreground">CRM 123456 • Nutrologia</p>
                </div>
                <div className="flex shrink-0 gap-1" aria-hidden>
                  <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-muted text-[11px]" title="Idioma">
                    🇺🇸
                  </span>
                  <span
                  ...
                  <span
                    className="flex h-8 w-8 items-center justify-center rounded-xl"
                    style={{ backgroundColor: '#E1306C18' }}
                  >
                    <svg viewBox="0 0 24 24" className="h-4 w-4" fill="#E1306C" aria-hidden>
              ...
              <p className="mt-2.5 px-1 text-center text-[11px] italic leading-snug text-muted-foreground">
                Viva sua melhor versão, com amor, Dra. Carine Cassol
              </p>
              <div className="mt-2 flex justify-center">
                <span
                  className="rounded-full px-3 py-1.5 text-[8px] font-semibold uppercase tracking-wide text-[#0f766e] sm:text-[9px]"
          ...
          {/* Corpo: busca + resultados (como na página do paciente) */}
          <div className="bg-gradient-to-b from-muted/25 to-[#f7faf9] px-3 pb-2 pt-3">
            <div className="relative">
              <Search className="pointer-events-none absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground/60" />
              <div className="flex min-h-[40px] items-center rounded-2xl border border-border/60 bg-card py-2 pl-9 pr-3 shadow-sm">
            ...
            <div className="mt-2.5 min-h-[168px] space-y-2 pb-1">
              <p className="px-1 text-[10px] font-medium text-muted-foreground">8 substituições encontradas</p>
              {[
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-[12px] font-semibold text-gray-800">{item.name}</p>
                    <p className="text-[10px] text-gray-400">Equivalência proteica</p>
                  </div>
                  <span className="shrink-0 rounded-full bg-[#0F766E]/10 px-2 py-0.5 text-[11px] font-bold text-[#0F766E]">
                    {item.pct}
                  </span>
                </div>
              ))}
            ...
            <div className="flex justify-center pb-1 pt-1">
              <div className="h-1 w-28 rounded-full bg-black/12" aria-hidden />
            </div>
          </div>
        </div>
      </div>
      ...
      <motion.div
        ...
        className="absolute -left-4 top-[46%] max-sm:-left-2 max-sm:scale-90 sm:-left-6 sm:top-[44%] bg-white rounded-2xl border border-[#0F766E]/10 px-3 py-2.5 shadow-xl sm:px-4 sm:py-3"
      >
